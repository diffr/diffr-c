...
if (GLIB_PKG_FOUND)
    ...
    find_path(GLIB_CONFIG_INCLUDE_DIR NAMES glibconfig.h PATHS ${GLIB_PKG_LIBDIR} ${GLIB_INCLUDE_DIR} PATH_SUFFIXES glib-2.0/include)
...
if (GLIB_INCLUDE_DIR AND GLIB_CONFIG_INCLUDE_DIR AND GLIB_LIBRARIES)
    set(GLIB_INCLUDE_DIRS ${GLIB_INCLUDE_DIR} ${GLIB_INCLUDE_DIR}/.. ${GLIB_CONFIG_INCLUDE_DIR})
